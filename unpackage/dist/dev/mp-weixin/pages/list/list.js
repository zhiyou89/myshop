...
/***/ 60:
/*!************************************************************************************************!*\
  !*** C:/Users/zhiyou/Documents/HBuilderProjects/wechat/main.js?{"page":"pages%2Flist%2Flist"} ***!
  \************************************************************************************************/
...
/***/ 61:
/*!*****************************************************************************!*\
  !*** C:/Users/zhiyou/Documents/HBuilderProjects/wechat/pages/list/list.vue ***!
  \*****************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _list_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list.vue?vue&type=style&index=0&lang=scss& */ 66);
...
/***/ 62:
/*!************************************************************************************************************!*\
  !*** C:/Users/zhiyou/Documents/HBuilderProjects/wechat/pages/list/list.vue?vue&type=template&id=7d5e07c6& ***!
  \************************************************************************************************************/
...
var components = {
  goodsList: function() {
    return __webpack_require__.e(/*! import() | components/goods-list/goods-list */ "components/goods-list/goods-list").then(__webpack_require__.bind(null, /*! @/components/goods-list/goods-list.vue */ 246))
  },
  noMessageNotice: function() {
    return __webpack_require__.e(/*! import() | components/no-message-notice/no-message-notice */ "components/no-message-notice/no-message-notice").then(__webpack_require__.bind(null, /*! @/components/no-message-notice/no-message-notice.vue */ 260))
  }
}
var render = function() {
  var _vm = this
...
/***/ 64:
/*!******************************************************************************************************!*\
  !*** C:/Users/zhiyou/Documents/HBuilderProjects/wechat/pages/list/list.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 65:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/zhiyou/Documents/HBuilderProjects/wechat/pages/list/list.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var goodsList = function goodsList() {Promise.all(/*! require.ensure | components/goods-list/product-by-category */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/goods-list/product-by-category")]).then((function () {return resolve(__webpack_require__(/*! components/goods-list/product-by-category */ 274));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var noMessageNtice = function noMessageNtice() {__webpack_require__.e(/*! require.ensure | components/no-message-notice/no-message-notice */ "components/no-message-notice/no-message-notice").then((function () {return resolve(__webpack_require__(/*! components/no-message-notice/no-message-notice.vue */ 260));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var loading = function loading() {__webpack_require__.e(/*! require.ensure | components/loading-view/product-loading */ "components/loading-view/product-loading").then((function () {return resolve(__webpack_require__(/*! components/loading-view/product-loading.vue */ 218));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var topIcon = function topIcon() {__webpack_require__.e(/*! require.ensure | components/gwh-backTopIcon/gwh-backTopIcon */ "components/gwh-backTopIcon/gwh-backTopIcon").then((function () {return resolve(__webpack_require__(/*! components/gwh-backTopIcon/gwh-backTopIcon.vue */ 288));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  data: function data() {var _ref;
    return _ref = {
      ...
      triggered: false,
      _freshing: false,
      showlistData: [] }, _defineProperty(_ref, "scrollTop",
    0), _defineProperty(_ref, "old",
    {
      scrollTop: 0 }), _defineProperty(_ref, "deliveryNav",
  ...
  methods: {
    ...
    //中间导航点击事件
    middleNav: function middleNav(mNavID) {
      this.mNavID = mNavID;
      var has = this.isHas();
      if (has) {
        this.showData();
    ...
    //左边导航点击事件
    getCategoryProduct: function getCategoryProduct(index, categoryID) {
    ...
    //初始化product
    intOrderData: function intOrderData() {
    ...
    //将数据push进productlist
    pushProduct: function pushProduct(res) {
      for (var i = 0; this.productList.length > i; i++) {
        if (this.productList[i].categoryid == this.categoryID &&
        this.productList[i].indexCategoryID == this.mNavID)
        {
          for (var y = 0; res.length > y; y++) {
    ...
    //找出数据里面对应的pages
    findValuePages: function findValuePages() {
    ...
    //找出对应的flash
    findValueFlash: function findValueFlash() {
    ...
    //更新page
    updatePages: function updatePages(pages) {
      for (var i = 0; this.productList.length > i; i++) {
        if (this.productList[i].categoryid == this.categoryID &&
        this.productList[i].indexCategoryID == this.mNavID)
        {
    ...
    //更新flash
    updateFlash: function updateFlash(flash) {
      for (var i = 0; this.productList.length > i; i++) {
        if (this.productList[i].categoryid == this.categoryID &&
        this.productList[i].indexCategoryID == this.mNavID)
        {
    ...
    //更新mNAV
    updateindexCategoryID: function updateindexCategoryID(mNav) {
      for (var i = 0; this.productList.length > i; i++) {
        if (this.productList[i].categoryid == this.categoryID &&
        this.productList[i].indexCategoryID == this.mNavID)
        {
    ...
    lower: function lower() {
      ...
      var pages = this.findValuePages();
      pages++;
      this.getProductList(pages);
    },

    getProductCategory: function getProductCategory() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  _this.$myrequest({
                    url: '/category/all/1' }));case 2:res = _context.sent;

                _this.ProductCategory = res;case 4:case "end":return _context.stop();}}}, _callee);}))();

    },
    getProductList: function getProductList(page) {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  _this2.$myrequest({
                    url: '/category/list_products',
                    data: {
                      categoryId: _this2.categoryID,
                      indexCategoryID: _this2.mNavID,
                      pages: page } }));case 2:res = _context2.sent;



                if (!res.data.length) {
                  _this2.updateFlash(true);

                } else {
                  _this2.updatePages(page);
                }
                _this2.pushProduct(res.data);
                _this2.showData();case 6:case "end":return _context2.stop();}}}, _callee2);}))();
  ...
  onShow: function onShow() {
    var listid = uni.getStorageSync('listID');
    if (listid) {
...
/***/ 66:
/*!***************************************************************************************************************!*\
  !*** C:/Users/zhiyou/Documents/HBuilderProjects/wechat/pages/list/list.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
